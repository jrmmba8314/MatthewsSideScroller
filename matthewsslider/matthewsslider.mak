# ---------------------------------------------------------------------------
!if !$d(BCB)
BCB = "c:\users\public\borland\bcc55"
!endif
...
VERSION = BCB.05.00
# ---------------------------------------------------------------------------
PROJECT = "matthewsslider.exe"
OBJFILES = StateMachineFun.obj GameNodeFun.obj LoadActorsFun.obj MyGame.obj \
    GameFunctions.obj MyFunctions.obj LocalDataFun.obj
RESFILES = "fun.res"
MAINSOURCE = "matthewsslider.bpf"
RESDEPEN = $(RESFILES)
LIBFILES = 
IDLFILES = 
IDLGENFILES = 
...
INCLUDEPATH = "C:\Users\jrmmba\Documents\matthewsslider";$(BCB)\include;"C:\Users\Public\FunEditor1.5\Library\FunInclude"
LIBPATH = "C:\Users\jrmmba\Documents\matthewsslider";$(BCB)\lib;$(BCB)\Lib\Psdk;"C:\Users\Public\FunEditor1.5\Library\FunLibBC"
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
